...
export class FriendshipService {
  ...
  getAllFriendships(userId: number | undefined): Observable <Friendship[]>{
    return this.http.get<Friendship[]>(`${this.baseURL}?userId=${userId}&_sort=friend.nickname&_order=asc`);
  }
  ...
  deleteFriendship(id: number): Observable<boolean> {
